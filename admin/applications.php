...
<div class="wrapper">
                  ...
                  <table id="example2" class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <?php if($row['resume'] != '') { ?>
                        <td><a href="../admin/uploads/resume/<?php echo $row['resume']; ?>" download="<?php echo $row['firstname'].' Resume'; ?>"><i class="fa fa-file-pdf-o"></i></a></td>
                        <?php } else { ?>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <br>
              <h3><b>Website</b></h3>
              <p>http://www.JobRecruitment.tech/</p>
              <br>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2019-2020 <a href="http://www.JobRecruitment.tech/">JobPortal</a>.</strong> All rights
    reserved.
    </div>
  </footer>
