  ...
  <div class="content-wrapper" style="margin-left: 0px;">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li><a href="udemyposts.php"><i class="fa fa-building"></i> Udemy Posts</a></li>
          ...
          <h3>JobRecruitment.Tech Statistics</h3>
            <div class="row">
              <div class="col-md-6">
                <div class="info-box bg-c-yellow">
                  <span class="info-box-icon bg-red"><i class="ion ion-ios-bolt"></i></span>
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-red">
                  <span class="info-box-icon bg-green"><i class="ion ion-ios-navigate"></i></span>
                  
                  <div class="info-box-content">
                    <span class="info-box-text">Total Udemy Posts</span>
                    <?php
              ...
              <div class="col-md-6">
                <div class="info-box bg-c-red">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Expired Udemy Posts</span>
                    <?php
