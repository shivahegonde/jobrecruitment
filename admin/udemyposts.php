            ...
            <div class="box box-solid">
              ...
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-stacked">
                  ...
                  <li class="active"><a href="udemyposts.php"><i class="fa fa-building"></i> Udemy Posts</a></li>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <?php
                         if ($row['active'] == '0') {
                            ?>
                              <a href="expire-course.php?id=<?php echo $row['id_udemypost']; ?>">Make it Expired</a>
                            <?php
                          } else if($row['active'] == '1') {
                            echo "Expired | ";
                            ?>
                              <a href="active-course.php?id=<?php echo $row['id_udemypost']; ?>">Make it Active</a>
                            <?php
                          }
                        ?>             
                        </td>
                        
                        <td><a href="delete-course.php?id=<?php echo $row['id_udemypost']; ?>">Delete</a></td>
                      </tr>  
                     <?php
                        }
                      }
