            ...
            <div class="row margin-top-20">
              ...
              <?php
               $sql = "SELECT * FROM job_post WHERE id_company='$_SESSION[id_company]' AND id_jobpost='$_GET[id]'";
                ...
                <hr>
                <div>
                  <p><span class="margin-right-10"><i class="fa fa-location-arrow text-green"></i> <?php echo $row['experience']; ?> Years Experience</span> <i class="fa fa-calendar text-green"></i> <?php echo date("d-M-Y", strtotime($row['createdat'])); ?><span>&nbsp &nbsp</spam> <span class="margin-right-10"><i class="fa fa-location-arrow text-green"></i><a href='<?php echo $row['joblink']; ?>'> Job Link</span></p>              
                </div>
                <div>
                  <p> </p>              
                </div>
