            ...
            <div class="row">
              <form method="post" action="addpost.php">
                <div class="col-md-12 latest-job ">
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control  input-lg" id="minimumsalary"  autocomplete="off" name="minimumsalary" placeholder="Minimum Salary" required="">
                  </div>
                  <div class="form-group">
                    <input type="text" class="form-control  input-lg" id="maximumsalary" name="maximumsalary" placeholder="Maximum Salary" required="">
                  </div>
                  <div class="form-group">
                <input type="number" class="form-control  input-lg" id="experience" autocomplete="off" name="experience" placeholder="Experience (in Years) Required" required="">
                  ...
                  <div class="form-group">
                <select class="form-control  input-lg" id="joblocation" name="joblocation" required>
                <option selected="" value="">Select Job Location</option>
		<option value="Work From Home">Work From Home</option>
		<option value="Anywhere In India">Any Where In India</option>
                <?php
                  $sql="SELECT * FROM indiancities";
                  $result=$conn->query($sql);

                  if($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                      echo "<option value='".$row['city_name']."' data-id='".$row['id']."'>".$row['city_name']."</option>";
                    }
                  }
                ?>
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control  input-lg" id="joblink" name="joblink" placeholder="Job Link" required="">
                  </div>
