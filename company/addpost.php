...
if(isset($_POST)) {
	...
	$stmt = $conn->prepare("INSERT INTO job_post(id_company, jobtitle, description, minimumsalary, maximumsalary, experience, qualification,joblocation,joblink) VALUES (?,?,?, ?, ?, ?, ?, ? ,?)");

	$stmt->bind_param("issssssss", $_SESSION['id_company'], $jobtitle, $description, $minimumsalary, $maximumsalary, $experience, $qualification,$joblocation,$joblink);
	...
	$joblink = mysqli_real_escape_string($conn, $_POST['joblink']);
