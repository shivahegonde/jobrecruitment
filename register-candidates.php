...
<head>
  ...
  <![endif]-->
<script src="https://www.google.com/recaptcha/api.js?render=6LeATNMZAAAAACjTBta2a2rrh9CkEuA-IeQEwNVG"></script>
      ...
      <div class="container">
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          <h1 class="text-center margin-bottom-20">CREATE YOUR PROFILE</h1>
       		<form method="post" id="registerCandidates" action="adduser.php" enctype="multipart/form-data" onSubmit="return validation();">
            <div class="col-md-6 latest-job ">
              <div class="form-group">
                <input class="form-control input-lg" type="text" id="fname" name="fname" placeholder="First Name *" minlength="3" required>
              </div>
              <div class="form-group">
                <input class="form-control input-lg" type="text" id="lname" name="lname" placeholder="Last Name *" minlength="3" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input class="form-control input-lg" type="date" id="dob" min="1980-01-01" max="2005-01-31" name="dob" placeholder="Date Of Birth">
              </div>
              <div class="form-group">
            ...
            <div class="col-md-6 latest-job ">
              <div class="form-group">
                <input class="form-control input-lg" type="password" id="password" name="password" minlength="8" maxlength="10" placeholder="Password *" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <input class="form-control input-lg" type="text" id="designation" name="designation" placeholder="Desired Designation">
              </div>
